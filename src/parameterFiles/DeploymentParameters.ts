...
export interface IParameterValues { //asdf move asdf consider storing pointer to DeploymentDoc
    // case-insensitive
    ...
    //asdf doc?  rename?
    //asdf needed? can use smaller interface? parametersContainingDocument: DeploymentDocument; //asdf?
