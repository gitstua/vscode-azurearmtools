...
export class ShowCurrentParameterFileCodeLens extends ResolvableCodeLens {
    ...
    public async resolve(): Promise<boolean> {
        const dpUri = ext.deploymentFileMapping.getValue().getParameterFile(this.deploymentDoc.documentId);
        if (dpUri) {
            this.command = {
                title: `Parameter file: "${getRelativeParameterFilePath(this.deploymentDoc.documentId, dpUri)}"`, //asdf
    ...
    public async resolve(): Promise<boolean> {
        ...
        if (parameterValues) {
            ...
            this.command = {
                ...
                arguments: [
                    this.deploymentDoc.documentId, //asdf
                    parameterValues,
